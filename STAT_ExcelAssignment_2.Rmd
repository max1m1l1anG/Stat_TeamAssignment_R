...
pval_DNEWHIRES <- 2 * ifelse(TestStat_DNEWHIRES > 0, pnorm(-TestStat_DNEWHIRES, 0, 1), pnorm(TestStat_DNEWHIRES, 0, 1))
...
z_alpha_300_AGE <- qt(1-alpha, 300)
TestStat_AGE <- (mean_AGE - 11)/(sd_AGE / nrow(sample)^0.5)

H0_AGE <- ifelse(z_alpha_300_AGE > TestStat_AGE, "Do not reject H0", "Reject H0")

cat("Age:", 
    "\nThe critical value is", z_alpha_300_AGE,
...
z_alpha_300_EMP <- qt(alpha, 300)
TestStat_EMP <- (mean_EMP - 100)/(ssd_EMP / nrow(sample)^0.5)

H0_EMP <- ifelse(z_alpha_300_EMP < TestStat_EMP, "Do not reject H0", "Reject H0")

cat("Employment:", 
    "\nThe critical value is", z_alpha_300_EMP,
